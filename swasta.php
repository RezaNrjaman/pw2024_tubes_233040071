...
$queryUniversitas = mysqli_query($conn, "SELECT id, nama, jumlah, foto FROM universitas WHERE kategori_id=2");
?>
...
<body>
    <div class="container-fluid py-5 warna3" id="universitas">
        <div class="container text-center">
            <h3><a href="index.php"><i class="fa-solid fa-backward" style="margin-right: 25px; color:black;"></i></a>UNIVERSITAS SWASTA</h3>
            <div class="row mt-5">
                <?php
